    ...
    <table border="2">
        ...
        <%
            try
            {
                ...
                String query="select d.dog_id,p.pet_type,d.breedname,d.sex,d.age,d.color,d.price from pet p right join dog d on p.pet_id=d.pet_id inner join cart c on c.dog_id = d.dog_id where user_id = 1;  ";
