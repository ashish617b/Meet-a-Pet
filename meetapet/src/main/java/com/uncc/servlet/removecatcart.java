...
public class removecatcart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            PreparedStatement ps=con.prepareStatement("delete from cart1 where user_id = '"+u_id+"' and cat_id = '"+cat_id+"' ");
            ...
            if(status ==1) {
                ...
                response.sendRedirect("checkcat.jsp");
