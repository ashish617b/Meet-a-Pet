...
<form>
    ...
    <%
        ...
        ResultSet rs = stmt.executeQuery("select c.accessoryname,c.price,c.accessory_id,a.order_id from accessorycat c\n" +
    ...
    <% }%>
    <%
        ResultSet rs1 = stmt.executeQuery("select c.accessoryname,c.price,c.accessory_id,a.order_id from accessorycat c\n" +
                "INNER JOIN add_to_cart_accessory_cat a on a.accessory_id=c.accessory_id \n" +
                "where a.order_id = (select max(order_id) from add_to_cart_accessory_cat) ;");
    %>
